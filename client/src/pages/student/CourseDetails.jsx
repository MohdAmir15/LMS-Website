...
const CourseDetails = () => {
  ...
  const {allCourses, calculateRating, calculateNoOfLectures, calculateCourseDuration, calculateChapterTime,
  ...
  return courseData ? (
    ...
    md:px-36 px-8 md:pt-30 pt-20 text-left'>
        ...
        <div className='max-w-xl z-10 text-gray-500'>
          ...
          <p className='pt-4 md:text-base text-sml' 
                          ...
                          <li key={i} className='flex items-start gap-2 py-1'>
                            ...
                            <div className='flex items-center justify-between w-full text-gray-800 text-xs md:text-default'>
                              ...
                              <div className='flex gap-2'>
                                ...
                                <p>{humanizeDuration(lecture.lectureDuration * 60 * 1000, {unit: ["h", "m"]})}</p>
                                </div>
                            </div>
                          </li>
                        ))}
        ...
        {/* right col */}
        <div className='course-card z-10 custom-card rounded-t md:rounded-none overflow-hidden bg-white
        min-w-[300px] sm:min-w-[420px]'>
          ...
          <div className='p-5'>
                ...
                text-white font-medium cursor-pointer' >{isAlreadyEnrolled ? 'Already Enrolled' : 'Enroll Now'}</button>
                ...
                <div className='pt-6'>
                  ...
                  <ul className='ml-4 pt-2 text-sm md:text-default list-disc text-gray-500'>
                    ...
                    <li>Downloadable resorces and source code.</li>
                    <li>Quizzes to test our knowledge.</li>
